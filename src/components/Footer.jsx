      ...
      <div className="container-responsive py-12">
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-400">
              <div className="flex items-center group">
                ...
                <span className="group-hover:text-white transition">8762978777</span>
              </div>
              <div className="flex items-center group">
                <svg className="w-5 h-5 mr-2 group-hover:text-white transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="group-hover:text-white transition">info@lmart.com</span>
              </div>
              <div className="flex items-center group">
                <svg className="w-5 h-5 mr-2 group-hover:text-white transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="group-hover:text-white transition">56 Industrial Estate, SINDAGI- 586 128</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
            <p>&copy; 2024 Lmart. All rights reserved. | Since 2025</p>
